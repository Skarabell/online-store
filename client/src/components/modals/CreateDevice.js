        ...
        >
            <Modal.Header closeButton>
                <Modal.Title id="contained-modal-title-vcenter">
                    Добавить устройство</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                <Form>
                    <Dropdown className="mt-2 mb-2">
                        <Dropdown.Toggle>{device.setSelectedType || "Выберите тип"}</Dropdown.Toggle>
                        <Dropdown.Menu>
                    ...
                    <Dropdown className="mt-2 mb-2">
                        <Dropdown.Toggle>{device.setSelectedBrand || "Выберите бренд"}</Dropdown.Toggle>
                        <Dropdown.Menu>
